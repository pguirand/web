...
mysql_select_db($database_connex, $connex);
$query_SELECTGROUP = "SELECT * FROM groupe where groupe.NOM_GROUPE like '%oni%'";
...
mysql_select_db($database_connex, $connex);
$query_IDENT = "SELECT entite.ID_ENTITE, entite.NOM_ENTITE FROM entite WHERE entite.SIGLE like 'oni'";
...
?>
    ...
    <tr>
      <td width="171" class="style12"><div align="left">NOM UTILISATEUR</div></td>
      <td width="416" class="style12"><label>
