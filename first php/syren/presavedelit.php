...
?>  
  <h2 align="center">PROCESSUS D'ENREGISTREMENT D'UN DELIT</h2>
  <p align="justify">&nbsp;</p>
<form id="form2" name="form2" method="GET" action="<?php echo $rechByNifAction; ?>">
                 
                  <h3 align="center">Recherche de l'individu ayant comis le délit:</h3>
<table width="319" height="156" border="1" id="comliste" align="center">
                    ...
                    <tr>
                      <td width="154"><label>
                        <input name="NUM_NIF" type="text" id="NUM_NIF" value="<?php echo $_GET['NUM_NIF'] ?>" maxlength="24" />
                      </label></td>
                      <td width="160"><p>
                        <label>
...
?>
  <div align="center">
   ...
   <div class="fonce">Résultats</div> 
    ...
    <br><br>
        <a href="savedelit.php?ID_IND=<?php echo $row_rechByNif['ID_IND']."&NOM_IND=".$row_rechByNif['NOM_IND'] ?>"><div id="menutop">Enregistrer Le Delit</div></a>  </div>
  <?php /*?><?php
