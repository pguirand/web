...
$query_religion = "SELECT individu.RELIGION FROM individu";
$religion = mysql_query($query_religion, $connex) or die(mysql_error());
...
$clause_nom = "NOM_IND like '".$colname_nom."%'";
$clause_prenom = "AND PRENOM_IND like '".$colname_prenom."%'";
$clause_sexe = "AND SEXE_IND = '".$colname_sexe."'";
$clause_profession = "AND PROFESSION like '%".$colname_profession."%'";
$clause_religion = "AND religion = '".$colname_catho."'";
...
if ($colname_catho == "") 
	...
	$cond = "WHERE";
	$clause_religion = "";
    $clause_religion = "AND religion like '".$colname_catho."'";
	}	
...
mysql_select_db($database_connex, $connex);
echo $query_rech_av = ("SELECT ID_IND, G_SANG_IND, SEXE_IND, NOM_IND, PRENOM_IND, NUM_NIF, NUM_CIF, PROFESSION, NUM_PASSPORT, EMAIL1 FROM individu ".$cond." ".$clause_nom." ".$clause_prenom." ".$clause_sexe." ".$clause_profession." ".$clause_religion."");
...
Catholique</label>                     
                      ...
                      Protestant</label><br>
                        <label>
<input <?php if (!(strcmp($row_religion['RELIGION'],"baptiste"))) {echo "checked=\"checked\"";} ?> type="checkbox" name="bapt" id="bapt" /> 
Baptiste</label>
                       <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
