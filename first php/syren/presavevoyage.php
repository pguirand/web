...
<?php include_once('menuh.php');?>
  ...
  <h2 align="center">PROCESSUS D'ENREGISTREMENT DE VOYAGE</h2>
  <p align="justify">&nbsp;</p>
...
?>
  <div align="center">
   <div class="logoutok">RECHERCHE VALIDE</div><BR>
...
<br><br>
        <a href="savevoyage.php?ID_IND=<?php echo $row_rechByNif['ID_IND']."&NOM_IND=".$row_rechByNif['NOM_IND'] ?>">
        <div id="menutop">Enregistrer Le Voyage</div>
        </a>        
  </div>
  <?php /*?><?php
