...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  ...
  echo $insertSQL = sprintf("INSERT INTO individu (G_SANG_IND, SEXE_IND, NOM_IND, PRENOM_IND, DATEH_NAIS, NATIONALITE_INDIVIDU, ID_IND, NUM_IDENTIFIANT_PERE, NUM_IDENTIFIANT_MERE, NUM_IDENTIFIANT_OEC, NUM_ID_TEMOIN1, NUM_ID_TEMOIN2, CHAMP_CREE_PAR, RELIGION, ETAT, STATUT_MATRIMONIAL) VALUES (%s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s,%s, %s)",
...
?>
    ...
    <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>" onSubmit="return formValidator()">
      <table border="0" cellpadding="0" cellspacing="0" id="midTable" align="center">
        ...
        <tr>
          ...
          <td><span class="style16">NO ACTE</span></td>
          ...
          <td width="85">NO PAGE</td>
          <td width="80"><input name="NO_PAGE" type="text" class="style16" id="NO_PAGE" style="text-transform:uppercase" size="10" maxlength="8"/></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="60"><span class="style16">GROUPE SANGUIN</span></td>
          ...
          <td width="91"><span class="style16">NATIONALITE</span></td>
  ...
  &nbsp;&nbsp;
          ...
          <td width="90"><span class="style16">HEURE DE NAISSANCE</span></td>
...
(format 24h)</label>
        ...
        <tr>
          ...
          <td width="98"><span class="style16">RELIGION</span></td>
