...
$query_UTIL = "SELECT U.NOM_UTIL, I.NOM_IND, I.PRENOM_IND, G.NOM_GROUPE, U.STATUT, E.NOM_ENTITE, P.POSTE FROM utilisateur U, INDIVIDU I, ENTITE E, GROUPE G, EMPLOIE P  WHERE U.ID_IND=I.ID_IND AND U.ID_GROUPE = G.ID_GROUPE AND U.ID_ENTITE = E.ID_ENTITE AND I.ID_IND = P.ID_IND AND P.ID_ENTITE = E.ID_ENTITE";
...
<table border="1">
  <tr>
    ...
    <td><div align="center">POSTE OCCUPE</div></td>
  </tr>
    <?php do { ?>
    </div>
    <tr>
      ...
      <td><div align="center"><?php echo $row_UTIL['POSTE']; ?></div></td>      
    </tr>
