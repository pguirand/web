...
?>
  ...
  <?php  $groupe = $_SESSION['NOM_GROUPE'];?>
    ...
    <br><br>
    <?php 
	  if ($groupe == "administrateur syren")
	   $url = "creation_usr.php";
	  if ($groupe == "administrateur dgi")
	   $url = "creation_usr_dgi.php";
	   if ($groupe == "administrateur oni")
	   $url = "creation_usr_oni.php";
	   if ($groupe == "administrateur archives")
	   $url = "creation_usr_archives.php";
	   if ($groupe == "administrateur ime")
	   $url = "creation_usr_immigration.php";
	   if ($groupe == "administrateur justice")
	   $url = "creation_usr_justice.php";
	   if ($groupe == "administrateur interieur")
	   $url = "creation_usr_interieur.php";
	   if ($groupe == "ADMINISTRATEUR TRAVAIL")
	   $url = "creation_usr_travail.php";
	   
	   ?>
        <a href="<?php echo $url;?>?ID_IND=<?php echo $row_rechByNif['ID_IND']."&NOM_IND=".$row_rechByNif['NOM_IND'] ?>">Cr&eacute;er l'utilisateur</a>  </div>
  <?php /*?><?php
