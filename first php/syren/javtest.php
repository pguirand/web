...
?>
    ...
    test
      <label>
      <input type="text" name="adres" id="adres" disabled="disabled"/>
      
      </label> 
      <a href="#" onclick="javascript:activate()">click to activate</a>
      <a href="#" onclick="javascript:desactivate()">click to desactivate</a>
