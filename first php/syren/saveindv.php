...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO document (NO_DOC, TYPE_DOC, LIEU_EVENNEMENT, NO_REG, NO_PAGE, DATE_EVENNEMENT, ID_IND, CHAMP_CREE_PAR) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString($_POST['NO_PAGE'], "text"),
					   GetSQLValueString($format, "date"),
					   GetSQLValueString($IDIND, "text"),
					   GetSQLValueString($IDutil, "int"));
...
?>
  ...
  <div class="story">
    ...
    <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>" onsubmit="return formValidator()">
      <table border="0" cellpadding="0" cellspacing="0" id="midTable" align="center">
        <tr class="head">
          <td colspan="9" class="header" align="center">INFORMATIONS A REMPLIR</td>
        </tr>
        <tr>
          <td width="77"><span class="style16">TYPE DOCUMENT</span></td>
          <td><span class="style10 style10 style16">
            <input name="TYPE_DOC" type="text" class="style16" id="TYPE_DOC" value="NAISSANCE" size="15" readonly="readonly" disabled="disabled"/>
          </span></td>
          <td><span class="style16">NUMERO ACTE</span></td>
          <td><input name="NO_DOC" type="text" class="style16" id="NO_DOC" style="text-transform:uppercase" size="15" maxlength="8"/></td>
          <td colspan="2">NO REGISTRE</td>
          <td><input name="NO_REG" type="text" class="style16" id="NO_REG" style="text-transform:uppercase" size="15" maxlength="8"/></td>
          <td width="88">NO PAGE</td>
          <td width="76"><input name="NO_REG" type="text" class="style16" id="NO_REG2" style="text-transform:uppercase" size="10" maxlength="8"/></td>
        </tr>
        <tr>
          <td><span class="style16">NOM </span></td>
          <td colspan="2"><input name="NOM_IND" type="text" class="style16" id="NOM_IND" style="text-transform:uppercase" size="33"/></td>
          <td><span class="style16">PRENOM</span></td>
          <td colspan="5"><input name="PRENOM_IND" type="text" class="style16" id="PRENOM_IND" style="text-transform:uppercase" size="33"/></td>
        </tr>
        <tr>
          <td><span class="style16">SEXE</span></td>
          <td width="136"><span class="style16">
              <label>
          ...
          <td width="61"><span class="style16">GROUPE SANGUIN</span></td>
          <td colspan="3"><select name="G_SANG_IND" class="style16" id="G_SANG_IND">
          ...
          <td width="89"><span class="style16">NATIONALITE</span></td>
        ...
        <tr>
          <td><span class="style16">DATE DE NAISSANCE</span></td>
  ...
  &nbsp;&nbsp;
          ...
          <td width="95"><span class="style16">HEURE DE NAISSANCE</span></td>
...
(format 24h)</label>
        ...
        <tr>
          <td><span class="style16">NOM HOPITAL</span></td>
          <td colspan="2"><span class="style16">
            <input name="LIEU_EVENNEMENT" type="text" id="LIEU_EVENNEMENT" style="text-transform:uppercase"/>
          </span></td>
          <td width="95"><span class="style16">RELIGION</span></td>
          <td colspan="5"><select name="RELIGION" class="style16" id="RELIGION">
            <option selected="selected">Choisissez une religion</option>
            <option value="CATHOLIQUE">CATHOLIQUE</option>
            <option value="PROTESTANT BAPTISTE">PROTESTANT BAPTISTE</option>
            <option value="PROTESTANT PANECOTISTE">PROTESTANT PANECOTISTE</option>
            <option value="TEMOIN DE JEOVAH">TEMOIN DE JEOVAH</option>
            <option value="ADVENTISTE">ADVENTISTE</option>
          </select>            <label></label></td>
        </tr>
        <tr>
          <td colspan="9" class="header" align="center">Adresse</td>
        </tr>
        <tr>
          <td height="29" colspan="9"><?php 
...
$dForm->DynamicDropDown_Close();   //Call to the Destructor type of function
        ...
        <tr>
          <td height="26" colspan="9"><p align="left" class="style16">
              <label></label>
              <label> NUMERO EDIFICE</label>
              <span class="style16">
              <input type="text" name="numero" id="numero" size="10"/>
              </span> NOM RUE <span class="style16">
        ...
        <tr>
          <td><span class="style16"><a href="#" onClick="openFormWin('popupere.php');return false;">Rechercher Père</a>
            </p>                            
          </span></td>
          ...
          <td colspan="3"><a href="#" class="style16" onClick="openFormWin2('popupmere.php');return false;">Rechercher M&egrave;re	</a></td>
          <td colspan="3"><div id="prop1" style="display:none">NOM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input name="lnamem" type="text" readonly="readonly"/> PRENOM : <input name="fnamem" type="text" readonly="readonly"/> <input name="idm" type="hidden" /></div></td>
        </tr>
        <tr>
          <td><a href="#" class="style16" onClick="openFormWin3('popuptem1.php');return false;">Rechercher 1er temoin</a></td>
          ...
          <td colspan="3"><a href="#" class="style16" onClick="openFormWin4('popuptem2.php');return false;">Rechercher 2eme temoin</a></td>
          <td colspan="3"><div id="prop3" style="display:none">NOM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input name="lname2" type="text" readonly="readonly"/> PRENOM : <input name="fname2" type="text" readonly="readonly"/> <input name="id2" type="hidden" /></div></td>
        </tr>
                    
        <tr>
          <td><a href="#" class="style16" onClick="openFormWin5('popupoec.php');return false;">Rechercher Officier Etat Civil</a></td>
          <td colspan="2"><div id="prop4" style="display:none">NOM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input name="lnameoec" type="text" readonly="readonly"/> PRENOM : <input name="fnameoec" type="text" readonly="readonly"/> <input name="idoec" type="hidden" /></div>          </td>
          <td><span class="style16">NUMERO DE TELEPHONE</span></td>
          <td colspan="5"><span class="style16">
            <input name="NUM_TEL1" type="text" class="style16" id="NUM_TEL1"/>
            </span><span class="style16">
            <input name="NUM_TEL2" type="text" class="style16" id="NUM_TEL2"/>
          </span>
          <span class="style16">
            <input name="NUM_TEL3" type="text" class="style16" id="NUM_TEL3"/>
          </span>
            <input name="NUM_TEL4" type="text" class="style16" id="NUM_TEL4"/>
          </td>
        </tr>
      </table>
      <p>
