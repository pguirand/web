...
mysql_select_db($database_connex, $connex);
$query_SELECTGROUP = "SELECT * FROM groupe where groupe.NOM_GROUPE like '%travail%'";
...
mysql_select_db($database_connex, $connex);
$query_IDENT = "SELECT entite.ID_ENTITE, entite.NOM_ENTITE FROM entite WHERE entite.SIGLE like 'MAST'";
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" onSubmit="return formValidator()">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="86%" border="2" id="comliste2">
    <tr>
      <td colspan="2"><div align="center"><strong>Param&egrave;tres Utilisateur </strong></div></td>
    </tr>
    <tr>
      <td class="style12">NOM INDIVIDU</td>
      <td class="style12"><label><?php echo $row_liste_ind['PRENOM_IND']; ?> <?php echo $row_liste_ind['NOM_JEUNE_FILLE']; ?> <?php echo $row_liste_ind['NOM_IND']; ?></label></td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      <td width="155" class="style12">NOM UTILISATEUR</td>
      <td width="449" class="style12"><label>
        <input name="NOM_UTIL" type="text" id="NOM_UTIL" size="30"  />
      </label></td>
    </tr>
    <tr>
      <td class="style12"><div align="left">MOT DE PASSE</div></td>
      <td class="style12"><input name="MOT_PASS" type="password" id="MOT_PASS" size="30" /></td>
    </tr>
    <tr>
      <td class="style12">CONFIRMER MOT DE PASSE</td>
      <td class="style12"><input name="MOT_PASS2" type="password" id="MOT_PASS2" size="30" onblur="return checkPass(form1)" /></td>
    </tr>
    <tr>
