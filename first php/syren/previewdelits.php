...
<td><label>
      ...
      <div class="section">
		    ...
		    <div id="right">
		      ...
		      <h2 align="center">ViSUALISER LES DELITS PAR INDIVIDUS</h2>
		      <p align="justify">&nbsp;</p>
...
?>
   ...
   <div class="fonce">Résultats</div> 
      ...
      <br><br>
          <a href="liste_delit_ind.php?ID_IND=<?php echo $row_rechByNif['ID_IND']."&NOM_IND=".$row_rechByNif['NOM_IND'] ?>">Voir d&eacute;lit(s)</a>        
      </div>
      <?php /*?><?php
...
<?php
	...
	$error= "<div class='warning'>Aucun identifiant ne correspond a cette requête</div>";
	echo $error;
?>
            </div>
  <!-- InstanceEndEditable -->
