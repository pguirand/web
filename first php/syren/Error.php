           ...
           <div class="loginbar">
		    ...
		    <li><a href="#" class="MenuBarItemSubmenu">Utilisateurs</a>
                <ul>
                  ...
                  <li><a href="Error.php">Lister utilisateurs</a></li>
...
?>
			...
			?>
                <br>
              <div class="warning"> 
                <p class="style16">Ce segment est en cours de developpement et sera disponible bient&ocirc;t!!!!</p>
                <p align="center"><img src="Images/En_Construction.jpg" width="380" height="285" /></p>
              </div>
		      <?php
	}
else
