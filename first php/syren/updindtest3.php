...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE coordonnees SET NUM_TEL1=%s, NUM_TEL2=%s, NUM_TEL3=%s, NUM_TEL4=%s, ID_IND=%s, CHAMP_MODIFIE_PAR=%s WHERE ID_COORD=%s",
...
?>
        ...
        <tr class="style14">
          <td>NUMERO NIF </td>
          <td colspan="3"><input name="NUM_NIF" type="text" class="style14" id="NUM_NIF" value="<?php echo $row_Recordset1['NUM_NIF']; ?>" readonly="readonly"/>
...
<div id="NUM_NIF_exists" style="font-size: 11px;font-weight: bold;color:#FF3300"> </div>
          ...
          <td>NUMERO CIN</td>
          <td colspan="2"><input name="NUM_CIF" type="text" class="style14" id="NUM_CIF" value="<?php echo $row_Recordset1['NUM_CIF']; ?>" size="26" readonly="readonly"/> 
