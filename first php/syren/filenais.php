...
if (isset($_GET['ID_IND'])) {
  $colname_docind = $_GET['ID_IND'];
}
mysql_select_db($database_connex, $connex);
$query_docind = sprintf("SELECT * FROM individu WHERE ID_IND = %s", GetSQLValueString($colname_docind, "text"));
$docind = mysql_query($query_docind, $connex) or die(mysql_error());
$row_docind = mysql_fetch_assoc($docind);
$totalRows_docind = mysql_num_rows($docind);
?>
...
?>
    <p>  
<p align="center"><br />
<div align="center" class="idsection">ACTE DE NAISSANCE</div>
<br />
  <div align="center"><iframe src="docnais.php?ID_IND=<?php echo $row_docind['ID_IND']; ?>" width="780" height="700""></iframe></div>
