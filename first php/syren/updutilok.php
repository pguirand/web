...
<body>
  ...
  <p>&nbsp;</p>
        ...
        <div class="idsection"> Syst&egrave;me de Renseignement National || SYREN</div>
      <div class="loginbar">
            <div class="text">
...
?>
              ...
              <h3>&nbsp;</h3>
		      <div class="logoutok"> 
			  Mise &agrave; jourEffectifve
			  </div>
		      <div class="story">
		        <p>&nbsp;</p>
		        <table width="200" border="1" id="entiteliste">
                  <tr>
                    <td class="head"><a href="/syren/rech_simple_util.php">Nouvel Enregistrement</a></td>
                    <td class="head"><a href="/syren/admininterf5.php">Retour Administration</a></td>
                  </tr>
                </table>
		        <p>&nbsp;</p>
		      </div>
