...
<?php include_once('menuleft.php')?>  </div>
	...
	?>
      ...
      <tr>
      <td width="250" rowspan="10" background="im/image_sondage2.jpg" style="background-position:center; background-repeat:no-repeat"> AFFICHER SONDAGES</td>
      ...
      <td background="im/actu_images.jpg"><marquee direction=up loop=true height="100">
Your text here
</marquee></td>
      </tr>
      <tr>
        <td background="im/pub_images.jpg"><marquee></marquee></td>
      </tr>
      </table>
      <br />
      <br />
