...
?>
    <div align="center">
   <div class="logoutok"> Utilisateur existant</div><BR>
   <div class="fonce">Résultats</div> 
      ...
      <br><br>
          <a href="updutil.php?ID_IND=<?php echo $row_rechByNif['ID_IND']."&NOM_IND=".$row_rechByNif['NOM_IND'] ?>">Modifier l'utilisateur</a>      </div>
      <?php /*?><?php
