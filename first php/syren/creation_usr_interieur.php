...
mysql_select_db($database_connex, $connex);
$query_SELECTGROUP = "SELECT * FROM groupe where groupe.NOM_GROUPE like '%interieur%'";
...
mysql_select_db($database_connex, $connex);
$query_IDENT = "SELECT entite.ID_ENTITE, entite.NOM_ENTITE FROM entite WHERE entite.SIGLE like 'MICTSN'";
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" onSubmit=" return formValidator()">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="84%" border="2" id="comliste2">
    <tr>
...
?>
    ...
    <tr>
      <td width="146" class="style12"><div align="left">NOM UTILISATEUR</div></td>
      <td width="290" class="style12"><label>
        <input name="NOM_UTIL" type="text" id="NOM_UTIL" maxlength="15"  />
      </label></td>
    </tr>
    <tr>
      <td class="style12">MOT DE PASSE</td>
