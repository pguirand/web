...
<form name="popForm" onsubmit="setMaster()">
                <input name="lname1" type="hidden" value="<?php echo $row_rechByNif['NOM_IND']; ?>">
<br>
<input name="fname1" type="hidden" value="<?php echo $row_rechByNif['PRENOM_IND'];?>" /><br>
<input name="id1" type="hidden" value="<?php echo $row_rechByNif['ID_IND'];?>"/>
