...
$query_Recordset1 = sprintf("SELECT * FROM individu WHERE ID_IND = %s ORDER BY ID_IND ASC", GetSQLValueString($colname_Recordset1, "text"));
...
mysql_select_db($database_connex, $connex);
echo $query_nomRue = sprintf("SELECT NOM_RUE FROM adresse WHERE ID_IND = '$colname_Recordset1'", GetSQLValueString($colname_nomRue, "text"));
		      ...
		      <div class="story">
		        ...
		        <form action="<?php echo $editFormAction; ?>" id="form2" name="form2" method="POST">
		          <table width="88%" border="1" id="comliste" align="center">
                    ...
                    <tr>
                      <td>ID Individu</td>
                    <td><input name="ID_IND" type="text" id="ID_IND" value="<?php echo $row_Recordset1['ID_IND']; ?>" readonly="readonly"/></tr>
                    <tr>
                      <td width="171">NOM</td>
<td width="321"><label>
                        <input name="NOM_IND" type="text" id="NOM_IND" value="<?php echo $row_Recordset1['NOM_IND']; ?>" />
                      </label></td>
                    </tr>
                    <tr>
                      <td>PRENOM</td>
                      <td><input name="PRENOM_IND" type="text" id="PRENOM_IND" value="<?php echo $row_Recordset1['PRENOM_IND']; ?>" /></td>
                    </tr>
                    <tr>
                      <td>SEXE</td>
                      <td><label>
                        <select name="SEXE_IND" size="1" id="SEXE_IND">
                    ...
                    <tr>
                      ...
                      <td><input name="NOM_RUE" type="text" id="NOM_RUE" /><?php $group = $_SESSION['NOM_GROUPE'];echo $group;?></td>
                    </tr>
                    <tr>
                      <td>Rue</td>
                      <td><label>
                        <input name="NOM_RUE" type="text" id="NOM_RUE" value="<?php echo $row_nomRue['NOM_RUE']; ?>" maxlength="100" />
                      </label></td>
                    </tr>
                    <tr>
                      <td>NIF</td>
                      <td><input type="text" name="NUM_IDENTIFIANT1" id="NUM_IDENTIFIANT1" value="<?php echo $row_Recordset1['NUM_NIF']; ?>"<?php if (($group != "operateur dgi")&&($group != "administrateur dgi")){?> readonly="readonly" <?php } ?>/> </td>
                    </tr>
                    <tr>
                      <td>CIN</td>
                      <td><input type="text" name="NUM_IDENTIFIANT2" id="NUM_IDENTIFIANT2" value="<?php echo $row_Recordset1['NUM_NIF']; ?>"<?php if (($group != "operateur oni")&&($group != "administrateur oni")){?> readonly="readonly" <?php } ?>/></td>
                    </tr>
                    <tr>
                      <td>No passeport</td>
                      <td><input type="text" name="NUM_IDENTIFIANT2" id="NUM_IDENTIFIANT2" value="<?php echo $row_Recordset1['NUM_NIF']; ?>"<?php if (($group != "operateur ime")&&($group != "administrateur ime")){?> readonly="readonly" <?php } ?>/></td>
                    </tr>
                  </table>
                  <?php
/*				  $dates = $_POST['jour']."-".$_POST['mois']."-".$_POST['an']."".$_POST['heure'].":".$_POST['min'];
