...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO adresse (NUM_EDIFICE, NOM_RUE, ID_SECCOM, ID_ENTITE, CHAMP_CREE_PAR) VALUES (%s, %s, %s,%s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO coordonnees (NUM_TEL1, NUM_TEL2, NUM_TEL3, NUM_TEL4, ID_ENTITE, CHAMP_CREE_PAR) VALUES (%s, %s, %s, %s, %s, %s)",
	    ...
	    <label>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        ...
                        <input name="eMail3" type="text" id="eMail3" size="23" maxlength="30" style="text-transform:lowercase"/>
                      </td>
                    </tr>
                    <tr>
                      <td>Site Web </td>
