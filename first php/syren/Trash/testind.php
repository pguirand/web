...
mysql_select_db($database_connex, $connex);
$query_DetailRS1 = sprintf("SELECT ID_IND, G_SANG_IND, SEXE_IND, NOM_IND, PRENOM_IND FROM individu WHERE ID_IND = %s", GetSQLValueString($colname_DetailRS1, "int"));
$query_limit_DetailRS1 = sprintf("%s LIMIT %d, %d", $query_DetailRS1, $startRow_DetailRS1, $maxRows_DetailRS1);
$DetailRS1 = mysql_query($query_limit_DetailRS1, $connex) or die(mysql_error());
...
<table border="1" align="center">
  <tr>
    <td>ID_IND</td>
    <td><?php echo $row_DetailRS1['ID_IND']; ?>
      <input type="file" name="fileField" id="fileField"  /></td>
  </tr>
  <tr>
    <td>G_SANG_IND</td>
    <td><?php echo $row_DetailRS1['G_SANG_IND']; ?> </td>
  </tr>
  <tr>
    <td>/<br />
      <br />
      ...
      ??????????????????????????
      SEXE_IND</td>
    <td><?php echo $row_DetailRS1['SEXE_IND']; ?> </td>
  </tr>
  <tr>
    <td>NOM_IND</td>
    <td><?php echo $row_DetailRS1['NOM_IND']; ?> </td>
  </tr>
  <tr>
    <td>PRENOM_IND</td>
    <td><?php echo $row_DetailRS1['PRENOM_IND']; ?> </td>
  </tr>
</table>
