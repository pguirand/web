...
function checkform()
                    {
					 ...
					 var emailtex = document.getElementById(eMail1);
...
?>
            ...
            <div align="center" class="title style16"> 
		      ...
		      <div class="story">
		        ...
		        <form action="<?php echo $editFormAction; ?>" action="saveentitesok.php" method="POST" enctype="multipart/form-data" name="form2" id="form2" onSubmit="return checkform()">  
