...
mysql_select_db($database_connex, $connex);
$query_IDENTIT = "SELECT entite.ID_ENTITE FROM entite WHERE entite.SIGLE LIKE 'dgi'";
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" >
  ...
  <table width="333" border="2">
    ...
    <tr>
      ...
      <td><label>
        <input name="NOM_ENT" type="text" id="NOM_ENT" />
      </label></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="MOT_PASS" type="password" id="MOT_PASS" /></td>
    </tr>
    <tr>
...
?>
  ...
  <p>
    ...
    <input name="ID_ENT" type="hidden" id="ID_ENT" value="<?php echo $row_IDENTIT['ID_ENTITE']; ?>" />
  </p>
  </form>
<!-- InstanceEndEditable -->
  <div class="spacer"></div>
