...
<script>
                      ...
                      function notEmpty(){
	                                                     if (!NOM_UTIL)
														 alert(ERREUR Le champ nom utilisateur ne peut pas être vide);
														 NOM_UTIL.focus();
		                                                 return false;
	                                                                                   }
	                                                     return true;
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO utilisateur (NOM_UTIL, MOT_PASS, STATUT, ID_GROUPE, ID_ENTITE, ID_IND, CREER_PAR) VALUES (%s, '$mot_pass', %s, %s, %s, %s, %s)",
