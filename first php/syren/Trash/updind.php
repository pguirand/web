...
mysql_select_db($database_connex, $connex);
$query_Recordset1 = sprintf("SELECT * FROM individu, `document` WHERE individu.ID_IND = %s AND individu.ID_IND=`document`.ID_IND ORDER BY individu.ID_IND ASC", GetSQLValueString($colname_Recordset1, "text"));
...
$colname_nomRue = "-1";
if (isset($_GET['ID_IND'])) {
  $colname_nomRue = $_GET['ID_IND'];
}
mysql_select_db($database_connex, $connex);
$query_nomRue = sprintf("SELECT NOM_RUE, NUM_EDIFICE FROM adresse WHERE ID_IND = '$colname_Recordset1'", GetSQLValueString($colname_nomRue, "text"));
$nomRue = mysql_query($query_nomRue, $connex) or die(mysql_error());
$row_nomRue = mysql_fetch_assoc($nomRue);
$idadr = $row_nomRue['ID_ADRESSE'];
$nomrue = $row_nomRue['NOM_RUE'];
$numedifice = $row_nomRue['NUM_EDIFICE'];
$totalRows_nomRue = mysql_num_rows($nomRue);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE adresse SET NOM_RUE=%s WHERE ID_IND='$colname_Recordset1'",
...
/*if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2") && ($_POST['NOM_RUE']!=$nomrue)) {
  $insertSQL = sprintf("INSERT INTO hist_adresse (NOM_RUE, ID_IND) values ('$nomrue', '$colname_Recordset1')");
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  ...
  $updateSQL = sprintf("UPDATE individu SET G_SANG_IND=%s, SEXE_IND=%s, NOM_IND=%s, PRENOM_IND=%s, NUM_NIF=%s,  NATIONALITE_INDIVIDU=%s WHERE ID_IND = '$colname_Recordset1'",
  ...
  <div class="story">
    ...
    <form action="<?php echo $editFormAction; ?>" id="form2" name="form2" method="POST">
      <table border="0" cellpadding="0" cellspacing="0" id="midTable" align="center">
        ...
        <td colspan="6"><input name="NO_DOC" type="text" class="style10 style10 style10 style10" id="NO_DOC" value="<?php echo $row_Recordset1['NO_DOC']; ?>" size="25" readonly="readonly"/>            </tr>
        <tr class="style14">
          <td width="77"><span class="style14 style10 style10 style10 style10">NOM</span></td>
<td><span class="style14 style10 style10 style10 style10">
  <label>
  <input name="NOM_IND" type="text" class="style14" id="NOM_IND" value="<?php echo $row_Recordset1['NOM_IND']; ?>" size="33" />
  </label>
</span></td>
        ...
        <td colspan="4"><span class="style14 style10 style10 style10 style10">
          <input name="NOM_JEUNE_FILLE" type="text" class="style14" id="NOM_JEUNE_FILLE" size="33" />
        </span><span class="style14 style10 style10 style10 style10">
          <label></label> <?php echo $groupe; ?>
        </span></td>
        </tr>
        <tr class="style14">
          <td><span class="style14 style10 style10 style10 style10">PRENOM</span></td>
          <td colspan="6"><input name="PRENOM_IND" type="text" class="style14" id="PRENOM_IND" value="<?php echo $row_Recordset1['PRENOM_IND']; ?>" size="33" /></td>
        </tr>
        <tr class="style14">
          <td><span class="style14 style10 style10 style10 style10">SEXE</span></td>
          <td width="179"><span class="style14 style10 style10 style10 style10">
            <label>
              <select name="SEXE_IND" size="1" class="style14" id="SEXE_IND">
                <option value="" <?php if (!(strcmp("", $row_Recordset1['SEXE_IND']))) {echo "selected=\"selected\"";} ?>>Masculin</option>
                <option value="" <?php if (!(strcmp("", $row_Recordset1['SEXE_IND']))) {echo "selected=\"selected\"";} ?>>Feminin</option>
                <?php
do {  
?>
...
?>
          ...
          <td width="66"><span class="style14 style10 style10 style10 style10">GROUPE SANGUIN</span></td>
          <td colspan="2"><span class="style14 style10 style10 style10 style10">
            <select name="G_SANG_IND" class="style14" id="G_SANG_IND">
              <option value="" <?php if (!(strcmp("", $row_Recordset1['G_SANG_IND']))) {echo "selected=\"selected\"";} ?>>A-</option>
              <option value="" <?php if (!(strcmp("", $row_Recordset1['G_SANG_IND']))) {echo "selected=\"selected\"";} ?>>O+</option>
              <option value="" <?php if (!(strcmp("", $row_Recordset1['G_SANG_IND']))) {echo "selected=\"selected\"";} ?>>O-</option>
              <option value="" <?php if (!(strcmp("", $row_Recordset1['G_SANG_IND']))) {echo "selected=\"selected\"";} ?>>B+</option>
              <option value="" <?php if (!(strcmp("", $row_Recordset1['G_SANG_IND']))) {echo "selected=\"selected\"";} ?>>B-</option>
              <option value="" <?php if (!(strcmp("", $row_Recordset1['G_SANG_IND']))) {echo "selected=\"selected\"";} ?>>AB+</option>
              <option value="" <?php if (!(strcmp("", $row_Recordset1['G_SANG_IND']))) {echo "selected=\"selected\"";} ?>>AB-</option>
              <?php
do {  
?>
              <option value="<?php echo $row_Recordset1['G_SANG_IND']?>"<?php if (!(strcmp($row_Recordset1['G_SANG_IND'], $row_Recordset1['G_SANG_IND']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset1['G_SANG_IND']?></option>
              <?php
} while ($row_Recordset1 = mysql_fetch_assoc($Recordset1));
  $rows = mysql_num_rows($Recordset1);
  if($rows > 0) {
...
?>
          ...
          <td width="86"><span class="style14 style10 style10 style10 style10">NATIONALITE</span></td>
          <td width="163"><span class="style14 style10 style10 style10 style10">
...
?>
        ...
        <tr class="style14">
          <td><span class="style14 style10 style10 style10 style10">DATE DE NAISSANCE</span></td>
          <td colspan="3"><span class="style14 style10 style10 style10 style10">
            <label>JOUR
        <select name="jour" class="style14" id="jour">
                  <option>01</option>
                  <option>02</option>
                  <option>03</option>
                  <option>04</option>
...
&nbsp;MOIS
                <select name="mois" class="style14" id="mois">
                    <option>01</option>
                  <option>02</option>
                  <option>03</option>
                  <option>04</option>
...
&nbsp;ANNEE
            <select name="an" class="style14" id="an">
              <option>1800</option>
              <option>1801</option>
              <option>1802</option>
              <option>1803</option>
          ...
          <td width="146"><span class="style14 style10 style10 style10 style10">HEURE DE NAISSANCE</span></td>
          <td colspan="2"><span class="style14 style10 style10 style10 style10">
            <label>
            Hre
            <select name="heure" class="style14" id="heure">
              <option>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
...
&nbsp;Min.
            <select name="min" class="style14" id="min">
              <option>00</option>
              <option>01</option>
              <option>02</option>
              <option>03</option>
 ...
 (format 24h)</label>
        ...
        <tr class="style14">
          <td>NIF</td>
          <td><input type="text" name="NUM_IDENTIFIANT1" id="NUM_IDENTIFIANT1" value="<?php echo $row_Recordset1['NUM_NIF']; ?>"<?php if (($groupe != "operateur dgi")&&($groupe != "administrateur dgi")){?> readonly="readonly" <?php } ?>/></td>
          <td>CIN</td>
          <td colspan="2"><input type="text" name="NUM_IDENTIFIANT3" id="NUM_IDENTIFIANT3" value="<?php echo $row_Recordset1['NUM_NIF']; ?>"<?php if (($groupe != "operateur oni")&&($groupe != "administrateur oni")){?> readonly="readonly" <?php } ?>/></td>
          <td>No passeport</td>
          <td><input type="text" name="NUM_IDENTIFIANT2" id="NUM_IDENTIFIANT2" value="<?php echo $row_Recordset1['NUM_NIF']; ?>"<?php if (($groupe != "operateur ime")&&($groupe != "administrateur ime")){?> readonly="readonly" <?php } ?>/></td>
        </tr>
        ...
        <tr class="style14">
          <td colspan="7"><span class="style16"><span class="style16 style14">NUMERO EDIFICE </span>
              <input name="NUMERO_EDIFICE" type="text" class="style14" id="NUMERO_EDIFICE" value="<?php echo $numedifice; ?>" size="10" />
&nbsp; &nbsp; NOM RUE
<input name="NOM_RUE" type="text" class="style14" id="NOM_RUE" value="<?php echo $row_nomRue['NOM_RUE']; ?>" size="55" />
          </span></td>
        </tr>
      </table>
      <?php
