...
?>
		      ...
		      <div class="story">
		        ...
		        <table width="200" border="1" id="entiteliste">
                  <tr>
                    <td width="34%" class="head"><a href="/syren/saveentites.php">Nouvel Enregistrement</a></td>
                    <td width="33%" class="head"><a href="/syren/admdgi.php">Retour Administration</a></td>
                    <td width="33%" class="head"><a href="/syren/admdgi.php">Imprimer Patente</a></td>
                  </tr>
                </table>
		        <p>&nbsp;</p>
		      </div>
