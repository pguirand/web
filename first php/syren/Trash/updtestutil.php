...
if ($pass1 != $pass2 ){?>
<script>
window.alert('Mots de passe differents');
$pass1.focus();
</script>
<?php }
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE utilisateur SET MOT_PASS='$pass1' WHERE NOM_UTIL=%s",
			...
			?>
		      ...
		      <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>">
                ...
                <table width="277" border="1">
                  <tr>
                    <td width="131">Nom utilisateur</td>
                    <td width="130"><label for="label"></label>
