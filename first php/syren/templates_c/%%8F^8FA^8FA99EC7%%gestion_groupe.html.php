<?php /* Smarty version 2.6.14, created on 2009-03-31 19:56:41
         compiled from gestion_groupe.html */ ?>
...
unset($_smarty_tpl_vars);
 ?>
		<div class="interface">
			<h2>Configuration > Gestion des groupes  </h2>
 ...
 groupe(s)</strong></p>
		...
		<form name="formulaire" method="post">
				<center>Sélectionner votre groupe : <select name="modif" id="formulaire" onChange='ChangeUrlmodif(this.form)'><?php echo $this->_tpl_vars['smartbox']; ?>
</select></center>
		</form>
		</ul>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "formulaire-ajout-groupe.html", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
