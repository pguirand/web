...
mysql_select_db($database_connex, $connex);
$query_SELECTGROUP = "SELECT * FROM groupe where groupe.NOM_GROUPE like '%economie%'";
...
mysql_select_db($database_connex, $connex);
$query_IDENT = "SELECT entite.ID_ENTITE, entite.NOM_ENTITE FROM entite WHERE entite.SIGLE like 'MEF'";
...
?> <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" onSubmit="return formValidator()">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="64%" border="2" id="comliste2">
    <tr>
...
?>
    ...
    <tr>
      <td width="169" class="style12"><div align="left">NOM UTILISATEUR</div></td>
      <td width="477" class="style12"><label>
