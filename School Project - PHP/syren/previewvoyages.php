...
<td><label>
      ...
      <div class="section">
		    ...
		    <div id="right">
		      ...
		      <h2 align="center">ViSUALISER LES VOYAGES PAR INDIVIDUS</h2>
		      <p align="justify">&nbsp;</p>
...
?>
   ...
   <div class="fonce">Résultats</div> 
      ...
      <br><br>
          <a href="liste_voy_ind.php?ID_IND=<?php echo $row_rechByNif['ID_IND']."&NOM_IND=".$row_rechByNif['NOM_IND'] ?>">Voir Voyage(s)</a>        
      </div>
      <?php /*?><?php
