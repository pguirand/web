...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO publications (TITRE_PUB, TYPE_PUB, CONTENU_PUB, ID_UTIL, STATUT, NOM_GROUPE) VALUES (%s, %s, %s, '$valid1', %s, %s)",
					   ...
					   GetSQLValueString($_SESSION['NOM_GROUPE'], "text"));
...
?>
  ...
  <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>">
    ...
    <br />
    Texte<br />
    <textarea name="textpub" id="textpub" cols="95" rows="20"></textarea>
    <br />
    <br />
