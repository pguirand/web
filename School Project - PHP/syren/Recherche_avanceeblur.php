...
echo $query_rech_av = ("SELECT * FROM individu ".$cond." ".$clause_nom." ".$clause_prenom." ".$clause_sexe." ".$clause_profession."");
      ...
      <table width="774" border="0" cellpadding="0" cellspacing="0" id="comliste">
        ...
        <tr>
          <td>Sexe :<br />
              ...
              <label>
                <input name="sexe" type="radio" id="sexe_0" onclick="document.getElementById('chsex').value = ''" value="radio" checked="checked" />
                Les Deux</label>
              <br />
              <label>
                <input type="radio" name="sexe" value="radio" id="sexe_1" onclick="document.getElementById('chsex').value = 'Masculin'"/>
                Homme</label>
            <br />
              <label>
                <input type="radio" name="sexe" value="radio" id="sexe_2" onclick="document.getElementById('chsex').value = 'Feminin'" />
                Femme</label>
              
              <input name="chsex" id="chsex" type="text" size="18" />
              <br />
          </td>
          <td><label></label>
            <label>Nom:<br />
              <input name="nom" type="text" id="nom" size="30" value="<?php echo $var_nom;?>" onFocus="clearText(this)" onBlur="clearText(this)" style=" color:#999; font-style:italic "onclick="document.getElementById('nom3').style.color ='black'; document.getElementById('nom3').style.fontStyle='normal'"/><br />
              
              Pr&eacute;nom
              :<br />
              <input name="prenom" type="text" id="prenom" size="30" value="<?php echo $var_prenom;?>" onFocus="clearText(this)" onBlur="clearText(this)" style=" color:#999; font-style:italic" onclick="document.getElementById('prenom3').style.color ='black'; document.getElementById('prenom3').style.fontStyle='normal'"/>
            </label></td>
          <td>Profession:
            <select name="profession" id="profession3">
          ...
          <td align="center"> Ages : <br />
            <br />
            <div align="center"> entre
              <label>
                <select name="age1" id="age6">
                  <option>0</option>
                  <option>1</option>
                  <option>2</option>
                  <option>3</option>
...
Témoins de Jehovah</label>
          ...
          <td width="133">Statut matrimonial:<br />
              ...
              <label>
                <input name="matri" type="radio" id="matri_0" value="radio" checked="checked" />
                Pas specifié</label>
              <br />
              <label>
                <input type="radio" name="matri" value="radio" id="matri_1" />
                Marié(e)</label>
              <br />
              <label>
                <input type="radio" name="matri" value="radio" id="matri_2" />
                Célibataire</label>
              <br />
              <label>
                <input type="radio" name="matri" value="radio" id="matri_3" />
                veuf(ve)</label>
               <br />
          </td>
        ...
        <tr>
          ...
          <td>Etat<br />
            <p>
              <label>
                <input name="etat" type="radio" id="etat_0" value="radio" checked="checked" onclick="document.getElementById('jourd').disabled=true;document.getElementById('moisd').disabled=true;document.getElementById('and').disabled=true"/>
                Vivant</label>
              <br />
              <label>
                <input type="radio" name="etat" value="radio" id="etat_1" onclick="document.getElementById('jourd').disabled=false;document.getElementById('moisd').disabled=false;document.getElementById('and').disabled=false"/>
                Decede(e)</label>
              <br />
          </p></td>
