...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO document (NO_DOC, TYPE_DOC, LIEU_EVENNEMENT, DATE_EVENNEMENT, ID_IND, CHAMP_CREE_PAR) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  <div class="story">
    ...
    <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>" onsubmit="return formValidator()">
      <table border="0" cellpadding="0" cellspacing="0" id="midTable" align="center">
        <tr class="head">
          <td colspan="8" class="header" align="center">INFORMATIONS A REMPLIR</td>
        </tr>
        <tr>
          <td width="81"><span class="style16">TYPE DOCUMENT</span></td>
          ...
          <td colspan="4"><input name="NO_DOC" type="text" class="style16" id="NO_DOC" style="text-transform:uppercase" size="20" maxlength="8"/></td>
        </tr>
        <tr>
          ...
          <td colspan="4"><input name="PRENOM_IND" type="text" class="style16" id="PRENOM_IND" style="text-transform:uppercase" size="33"/></td>
        </tr>
        <tr>
...
(format 24h)</label>
        ...
        <tr>
          ...
          <td colspan="4"><select name="RELIGION" class="style16" id="RELIGION">
        ...
        <tr>
          <td colspan="8" class="header" align="center">Adresse</td>
        </tr>
        <tr>
          <td height="29" colspan="8"><?php 
...
$dForm->DynamicDropDown_Close();   //Call to the Destructor type of function
        ...
        <tr>
          <td height="26" colspan="8"><p align="left" class="style16">
              <label></label>
