...
<div id="popupbody">
  ...
  <h2 align="center" class="style10">Recherche de l'époux</h2>
...
<form name="popForm" onsubmit="setMaster()">
                <input name="lnameoec" type="hidden" value="<?php echo $row_rechByNif['NOM_IND']; ?>">
<br>
<input name="fnameoec" type="hidden" value="<?php echo $row_rechByNif['PRENOM_IND'];?>" /><br>
<input name="idoec" type="hidden" value="<?php echo $row_rechByNif['ID_IND'];?>"/>
