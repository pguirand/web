<?php require_once('/syren/Connections/connex.php'); ?>
<?php
...
<link href="/syren/css/style.css" rel="stylesheet" type="text/css" />
<style type="text/css">
<!--
...
<div id="left">
<?php include_once('\syren\menuleft.php');?>
  </div>
  
  <div id="right">
    <?php 
include_once("/syren/menuh.php");
?>
    <p>
    <?php
if($_GET['search'] == "")
...
?>
  ...
  <p>  
  <p>              
  <p align="center"><img src="images/photos/entites/logos/logooni.jpg" alt="" name="oni" width="374" height="316" align="middle" id="oni" />              
