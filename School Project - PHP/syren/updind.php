...
$target1 = "images/photos/individus/photo";
$target2 = "AAAA".$target_path1.basename($_FILES['photo']['name']);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE individu SET EMPRINTE_IND=%s, G_SANG_IND=%s, SEXE_IND=%s, NOM_IND=%s, NOM_JEUNE_FILLE=%s, PRENOM_IND=%s, DATEH_NAIS=%s, PHOTO=%s, PHOTO_CIN=%s, PHOTO_PASS=%s, NUM_NIF=%s, DATE_EMISSION_NIF=%s, DATE_EXPIRATION_NIF=%s, LIEU_EMISSION_NIF=%s, NUM_CIF=%s, DATE_EMISSION_CIF=%s, DATE_EXPIRATION_CIF=%s, LIEU_EMISSION_CIF=%s, NUM_PASSPORT=%s, TYPE_PASS=%s, LIEU_EMISSION_PASS=%s, DATE_EMISSION_PASS=%s, DATE_EXPIRATION_PASS=%s, NATIONALITE_INDIVIDU=%s, EMAIL1=%s, CHAMP_MODIFIER_PAR=%s WHERE ID_IND=%s",
                       ...
                       GetSQLValueString($target2, "text"),
...
?>
        ...
        <tr class="style14">
          ...
          <td colspan="2" class="style14">TRAVAIL</td>
          <td colspan="2"><label>NOM ENTITE&nbsp;:&nbsp;<input name="entite" type="text" id="entite" value="<?php echo $row_Recordset3['NOM_ENTITE']; ?>" />
            <input name="id_entite" type="hidden" id="id_entite" />
            <br/>
            POSTE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<input name="poste" type="text" id="poste" value="<?php echo $row_Recordset3['POSTE']; ?>" />
          </label></td>
        </tr>
        ...
        <tr class="style14">
          <td colspan="7"><p><a href="javascript:void(null)" onclick="javascript:activate()">Cliquer sur ce lien pour changer l'adresse!!!</a></p>
            <p class="style16"><span class="style16 style14">NUMERO EDIFICE </span>
              <input name="NUMERO_EDIFICE" type="text" class="style14" id="NUMERO_EDIFICE" value="<?php echo $row_Recordset1['NUM_EDIFICE']; ?>" size="10" readonly="readonly" />
  &nbsp; &nbsp; NOM RUE
  <input name="NOM_RUE" type="text" class="style14" id="NOM_RUE" style="text-transform:uppercase" value="<?php echo $row_Recordset1['NOM_RUE']; ?>" size="55" readonly="readonly"/>
              <label>
              <input name="ID_SECCOM" type="hidden" class="style14" id="ID_SECCOM" value="<?php echo $row_Recordset1['ID_SECCOM']; ?>" readonly="readonly"/>
              </label>
            </p></td>
        </tr>
        <tr class="style14">
...
$dForm->DynamicDropDown_Close();   //Call to the Destructor type of function
      ...
      <label>
        <input name="ID_UTIL" type="hidden" id="ID_UTIL" value="<?php echo $IDutil; ?>" />
      </label>
<div align="center">
