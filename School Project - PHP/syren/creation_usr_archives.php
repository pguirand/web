...
mysql_select_db($database_connex, $connex);
$query_SELECTGROUP = "SELECT * FROM groupe where groupe.NOM_GROUPE like '%archives%'";
...
mysql_select_db($database_connex, $connex);
$query_IDENT = "SELECT entite.ID_ENTITE, entite.NOM_ENTITE FROM entite WHERE entite.SIGLE like 'anh'";
...
?>
    ...
    <tr>
      <td width="134" class="style12"><div align="left">NOM UTILISATEUR </div></td>
      <td width="302" class="style12"><label>
    ...
    <tr>
      <td class="style12"><div align="left">CONFIRMER MOT DE PASSE</div></td>
...
?>
    ...
    <tr>
      <td class="style12"><div align="left">SATUT</div></td>
      <td class="style12"><label>
