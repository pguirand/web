...
mysql_select_db($database_connex, $connex);
$query_SELECTGROUP = "SELECT * FROM groupe where groupe.NOM_GROUPE like '%justice%'";
...
mysql_select_db($database_connex, $connex);
$query_IDENT = "SELECT entite.ID_ENTITE, entite.NOM_ENTITE FROM entite WHERE entite.SIGLE like 'MJSP'";
...
?>
    ...
    <tr>
      <td width="173" class="style12"><div align="left">NOM UILISATEUR</div></td>
      <td width="457" class="style12"><label>
