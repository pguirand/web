...
mysql_select_db($database_connex, $connex);
$query_listepub = "SELECT publications.TITRE_PUB, publications.TYPE_PUB, publications.DATE_PUB, publications.STATUT, utilisateur.NOM_UTIL FROM publications, utilisateur WHERE publications.ID_UTIL=utilisateur.ID_UTIL ORDER BY publications.DATE_PUB ASC";
...
?>
				...
				echo $info
			?>
		      <table border="0" id="midTable" align="center">
  <tr class="header">
    <td>TITRE_PUB</td>
    <td>TYPE_PUB</td>
    <td>DATE_PUB</td>
  ...
  <?php do { ?>
  <tr>
    <td><?php echo $row_listepub['TITRE_PUB']; ?></td>
    <td><?php echo $row_listepub['DATE_PUB']; ?></td>
    <td><?php echo $row_listepub['STATUT']; ?></td>
    <td><?php echo $row_listepub['NOM_UTIL']; ?></td>
    td><a href="updentites.php?ID_ENTITE=<?php echo $row_listepub['TYPE_PUB']; ?>title="Modifier Entité"><img src="images/pencilart.jpeg" width="20" height="20"  border="0"</a></td>
  </tr>
