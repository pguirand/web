...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO ``document`` (NO_DOC, LIEU_EVENNEMENT, DATE_EVENNEMENT, HEURE_EVENNEMENT, NUM_IDENTIFICATION_TEMOIN1, TYPE_IDENTIFICATION_TEMOIN1, NUM_IDENTIFICATION_TEMOIN2, TYPE_IDENTIFICATION_TEMOIN2, ID_IND) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['NO_DOC'], "text"),
                       GetSQLValueString($_POST['LIEU_NAISSANCE'], "text"),
                       GetSQLValueString($_POST['DATE_EVENNEMENT'], "date"),
                       GetSQLValueString($_POST['HEURE_EVENNEMENT'], "date"),
                       GetSQLValueString($_POST['NUM_IDENTIFICATION_TEMOIN1'], "text"),
                       GetSQLValueString($_POST['TYPE_IDENTIFICATION_TEMOIN1'], "text"),
                       GetSQLValueString($_POST['NUM_IDENTIFICATION_TEMOIN2'], "text"),
                       GetSQLValueString($_POST['TYPE_IDENTIFICATION_TEMOIN2'], "text"),
                       GetSQLValueString($_POST['ID_IND'], "int"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO individu (ID_IND, G_SANG_IND, SEXE_IND, NOM_IND, PRENOM_IND, DATEH_NAIS, NUM_IDENTIFIANT_PERE, TYPE_IDENTIFIANT_PERE, NUM_IDENTIFIANT_MERE, TYPE_IDENTIFIANT_MERE, NATIONALITE_INDIVIDU) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['ID_IND'], "int"),
...
$colname_ID_IND = "-1";
if (isset($_SERVER['ID_IND'])) {
  $colname_ID_IND = $_SERVER['ID_IND'];
}
mysql_select_db($database_connex, $connex);
$query_ID_IND = sprintf("SELECT * FROM individu WHERE ID_IND = %s ORDER BY ID_IND ASC", GetSQLValueString($colname_ID_IND, "int"));
$ID_IND = mysql_query($query_ID_IND, $connex) or die(mysql_error());
$row_ID_IND = mysql_fetch_assoc($ID_IND);
$totalRows_ID_IND = mysql_num_rows($ID_IND);
?>
<?php
			...
			?>
		      ...
		      <div class="story">
		        ...
		        <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>">
		          <table width="89%" border="1" id="comliste" align="center">
                    <tr class="head">
                      <td colspan="2"><div align="center" class="fonce">INFORMATIONS A REMPLIR</div></td>
                    </tr>
                    <tr>
                      <td>TYPE EVENNEMENT</td>
                      <td><select name="TYPE_EVENNEMENT" size="1" id="TYPE_EVENNEMENT">
                    ...
                    <tr>
                      <td>No Document</td>
                      <td><input name="NO_DOC" type="text" id="NO_DOC" /></td>
                    </tr>
                    <tr>
                      <td width="172">NOM</td>
<td width="343"><label>
                    ...
                    <tr>
                      <td>IDENTIFIANT PERE</td>
                      <td><select name="TYPE_IDENTIFIANT_PERE" size="1" id="TYPE_IDENTIFIANT_PERE">
                        <option>NUMERO NIF</option>
                        <option>NUMERO CIF</option>
                        <option>NUMERO PASSEPORT</option>
                      </select>
                        <input type="text" name="NUM_IDENTIFIANT_PERE" id="NUM_IDENTIFIANT_PERE" /> <label></label></td>
                    </tr>
                    <tr>
                      <td>IDENTIFIANT MERE</td>
                      <td><select name="TYPE_IDENTIFIANT_MERE" size="1" id="TYPE_IDENTIFIANT_MERE">
                        <option>NUMERO NIF</option>
                        <option>NUMERO CIF</option>
                        <option>NUMERO PASSEPORT</option>
                      </select>
                          <input type="text" name="NUM_IDENTIFIANT_MERE" id="NUM_IDENTIFIANT_MERE" /></td>
                    </tr>
                    <tr>
                      <td>IDENTIFIANT OFFICIER</td>
                      <td><select name="TYPE_IDENTIFIANT_OFFICIER" size="1" id="TYPE_IDENTIFIANT_OFFICIER">
                        <option>NUMERO NIF</option>
                        <option>NUMERO CIF</option>
                        <option>NUMERO PASSEPORT</option>
                      </select>
                        <input type="text" name="NUM_IDENTIFIANT_OFFICIER" id="NUM_IDENTIFIANT_OFFICIER" /></td>
                    </tr>
                    <tr>
                      <td>IDENTIFIANT TEMOIN 1</td>
                      <td><select name="TYPE_IDENTIFICATION_TEMOIN1" size="1" id="TYPE_IDENTIFICATION_TEMOIN1">
                          <option>NUMERO NIF</option>
                          <option>NUMERO CIF</option>
                          <option>NUMERO PASSEPORT</option>
                        </select>
                    ...
                    <tr>
                      <td>IDENTIFIANT TEMOIN2</td>
                      <td><select name="TYPE_IDENTIFICATION_TEMOIN2" size="1" id="TYPE_IDENTIFIANT_PERE3">
                          <option>NUMERO NIF</option>
                          <option>NUMERO CIF</option>
                          <option>NUMERO PASSEPORT</option>
                        </select>
                          <input type="text" name="NUM_IDENTIFICATION_TEMOIN2" id="NUM_IDENTIFIANT_PERE3" />
                          <label></label></td>
                    </tr>
...
/*				  $dates = $_POST['jour']."-".$_POST['mois']."-".$_POST['an']."".$_POST['heure'].":".$_POST['min'];
				  ...
				  */
				  ?>
                    ...
                    <input name="ID_IND" type="hidden" id="ID_IND" value="<?php echo $row_ID_IND['ID_IND']; ?>" />
                    <input name="DATE_EVENNEMENT" type="hidden" id="DATE_EVENNEMENT" value="<?php echo date ('Y-m-d',$date);?>" />
                    <input name="HEURE_EVENNEMENT" type="hidden" id="HEURE_EVENNEMENT" value="<?php echo date ('H:i:s',$heure);?>" />
                    <label>
</p>
                  <p>&nbsp;                  </p>
                  <div align="center">
		        ...
		        <p>&nbsp;</p>
                <?php 
				$name = substr($_POST['nom'],2,4).substr($_POST['prenom'],-3,2);
				echo $name;
				?>
		      </div>
		      <?php
