...
?>
		      ...
		      <div class="story">
				...
				$url= "admarch.php";
				?>
		        <table width="200" border="0" id="entiteliste">
                  <tr>
                    <td class="head"><a href="/syren/saveind.php">Nouvel Enregistrement</a></td>
                    <td class="head"><a href="/syren/<?php echo $url;?>">Retour Administration</a></td>
                  </tr>
                </table>
		        <p>&nbsp;</p>
		      </div>
