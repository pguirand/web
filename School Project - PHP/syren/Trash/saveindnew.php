...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO adresse (NOM_RUE, ID_IND, CHAMP_CREE_PAR) VALUES (%s,%s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO document (NO_DOC, TYPE_DOC, LIEU_EVENNEMENT, DATE_EVENNEMENT, HEURE_EVENNEMENT, ID_IND, CHAMP_CREE_PAR) VALUES (%s, %s, %s,%s, %s, %s, %s)",
