...
<body>
  ...
  <p>&nbsp;</p>
        ...
        <!-- InstanceBeginEditable name="EditRegion4" -->
          ...
          <div class="idsection"> Office National d&rsquo;Identification || ONI </div>
           <div class="loginbar">
            <div class="text">
		    ...
		    <li><a href="#" class="MenuBarItemSubmenu">Individus</a>
		      <ul>
		        ...
		        <li><a href="Error.php">Recherche Avancee</a></li>
		        </ul>
	        </li>
...
?>
			...
			?>
	          ...
	          <p align="center"><br><br>
		        <img src="ONI" alt="ONI" width="334" height="323" /><br>
              <?php
	}
else
	echo " ".$nomutil."<br>";
