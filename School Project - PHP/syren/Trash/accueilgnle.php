...
if (isset($_POST['NOM_UTIL'])) {
  ...
  $MM_redirectLoginSuccess = "accueilgnle.php?result=yes";
  $MM_redirectLoginFailed = "accueilgnle.php?result=no";
...
if ($r == "yes")
	{
	$warning = "Connexion acceptée, Bonjour!!!";
	//echo '<div id="message".style.display='block';>';
	}
	else  $warning = "<div id='erreurlogin'>Nom d'utilisateur ou mot de passe incorrect</div>";
	}
?>
</head>
...
<div id="masthead">
  ...
  <div id="globalNav">
    <div align="left"><a href="#">Administration</a> | <a href="#">Saisie de Donn&eacute;es </a> | <a href="#">Contr&ocirc;le de donn&eacute;es </a> | <a href="#">Cellule d'enqu&ecirc;te </a> | <a href="#">Centre Statistique </a> | <a href="#">Recherche</a> | <a href="#">Aide ance </a> </div>
  </div>
</div>
<!-- end masthead -->
<div id="content">
    ...
    <ul>
      <form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
        <table width="247" border="0">
          ...
          <tr>
            <td width="97">Nom Utilisateur </td>
            <td width="140"><label>
