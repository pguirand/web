...
$query_Recordset1 = "SELECT NUM_PATENTE, NOM_ENTITE, ADRESSE1, TEL1, NUM_FAX FROM entite";
...
<div id="masthead">
  ...
  <a href="administration.php">Utilisateurs </a> |
...
<div id="content">
  ...
  <div class="feature">
    ...
    <table width="913" border="1">
      <tr>
        <td width="169">NUM_PATENTE</td>
        <td width="151">NOM_ENTITE</td>
        <td width="142">ADRESSE1</td>
        <td width="107">TEL1</td>
        <td width="133">NUM_FAX</td>
      </tr>
      <?php do { ?>
        <tr>
          <td><?php echo $row_Recordset1['NUM_PATENTE']; ?></td>
          <td><?php echo $row_Recordset1['NOM_ENTITE']; ?></td>
          <td><?php echo $row_Recordset1['ADRESSE1']; ?></td>
          <td><?php echo $row_Recordset1['TEL1']; ?></td>
          <td><?php echo $row_Recordset1['NUM_FAX']; ?></td>
        </tr>
