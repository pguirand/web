...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  ...
  $insertSQL = sprintf("INSERT INTO individu (G_SANG_IND, SEXE_IND, NOM_IND, PRENOM_IND, DATEH_NAIS, NATIONALITE_INDIVIDU, ID_IND) VALUES (%s, %s, %s, %s, %s, %s,%s)",
...
<td width="321"><label>
                    ...
                    <tr>
                      ...
                      <td><input name="NOM_RUE" type="text" id="NOM_RUE" /></td>
                    </tr>
                    <tr>
                      <td>NIF PERE</td>
