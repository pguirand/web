...
mysql_select_db($database_connex, $connex);
$query_Recordset1 = "SELECT entite.NOM_ENTITE FROM entite WHERE entite.ID_ENTITE = 1";
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" >
  ...
  <table width="333" border="2">
    ...
    <tr>
      ...
      <td><label>
        <input name="NOM_ENT" type="text" id="NOM_ENT" value="<?php echo $row_Recordset1['NOM_ENTITE']; ?>" />
      </label></td>
    </tr>
    <tr>
