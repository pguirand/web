...
if (isset($_SERVER['QUERY_STRING'])) {
 ...
 $userpass = md5($_POST['MOT_PASS']);
 
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {

  $insertSQL = mysql_query("INSERT INTO utilisateur (NOM_UTIL, MOT_PASS, STATUT, ID_GROUPE, ID_ENTITE, ID_IND, CREER_PAR) VALUES (%s, '$userpass', %s, %s, %s, %s, %s)",
...
$query_sql = "select * from utilisateur where NOM_UTIL ='" . $_POST['NOM_UTIL'] . "'";
$selectsql = mysql_query($query_sql, $connex) or die(mysql_error()); 
$row_sql = mysql_fetch_assoc($selectsql);
$totalRows_SELECTSQL = mysql_num_rows($selectsql);
