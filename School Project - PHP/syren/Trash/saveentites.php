...
function formValidator()
                    {
					 ...
					 var site = /^[\w\-\.\+]+\.[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}$/;
	                 if((eMail1.value.match(emailExp)), (eMail2.value.match(emailExp)), (eMail3.value.match(emailExp)), (siteweb.value.match(site)))
					                                 {
		                                              return true;
	                                                 }
                     else{		                  
					            alert('Format eMail ou siteweb incorrect ou sont vide; verifier les adresses inserées. Ex: jonh@doe.com, www.mysite.com');
					            return false;
	                     }
				    }
</script>
...
$name = strtoupper(substr($_POST['NOM_ENTITE'],1,2));
$pat = substr($_POST['NUM_PATENTE'],2,5);
$IDENT = $name.$dateb.$totalRows_IDENTITE;
...
//		 
//  }
 $insertSQL = sprintf("INSERT INTO adresse (NOM_RUE, ID_ENTITE) VALUES (%s, %s)",
  ...
  $insertSQL = sprintf("INSERT INTO entite (ID_ENTITE, NOM_ENTITE, NUM_PATENTE, SIGLE, SECTEUR_ACTIVITE, STATUT, NIVEAU, EMAIL1, EMAIL2, EMAIL3, SITE_WEB, LOGO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  					   GetSQLValueString($IDENT, "text"),
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO coordonnees (NUM_TEL1, NUM_TEL2, NUM_TEL3, NUM_TEL4, NUM_TEL5, NUM_TEL6, ID_ENTITE) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
if ($_GET['act'] == "denied")
	$info ="<div class='logindenied'>Vous devez vous identifier pour acceder à cette page !</div>";
?>
          ...
          <div class="idsection"> Direction Generale des Impots || DGI </div>
           <div class="loginbar">
		    ...
		    <li><a href="#" class="MenuBarItemSubmenu">Individus</a>
		      <ul>
		        <li><a href="updind.php">Modifier</a></li>
		        <li><a href="list_ind1.php">Lister</a></li>
		        <li><a href="rech_simple_ind.php">Rechercher</a></li>
		      </ul>
	        </li>
		    <li><a href="Error.php">Rech. Avanc&eacute;e</a></li>
...
?>
            <?php
				echo $info
			?>
            <div align="center" class="title style12 style10 style17"> 
                <h2>
				Formulaire d'enregistrement d'entités				</h2>
              </div>
		      <div class="story">
		        <p>&nbsp;</p>
		        <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form2" id="form2" onSubmit="return formValidator()">
                  <table width="358" border="1" id="entiteliste">
                    ...
                    <tr>
                      ...
                      <td><label>
                        <input name="numpat" type="text" id="numpat" size="17" maxlength="8" />
                      </label></td>
                    <tr>
                      <td width="78">Nom</td>
                      <td width="215">
