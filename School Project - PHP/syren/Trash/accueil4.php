...
if (isset($_POST['NOM_UTIL'])) {
  ...
  $MM_redirectLoginSuccess = "accueil4.php?result=yes";
  $MM_redirectLoginFailed = "accueil4.php?result=no";
...
<div id="masthead">
  ...
  <div id="globalNav">
    <div align="left"><a href="#">Administration</a> | <a href="#">Saisie de Donn&eacute;es </a> | <a href="#">Contr&ocirc;le de donn&eacute;es </a> | <a href="#">Cellule d'enqu&ecirc;te </a> | <a href="#">Centre Statistique </a> | <a href="#">Recherche</a> | <a href="#">Aide?</a></div>
  </div>
</div>
<!-- end masthead -->
<div id="content">
