...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  ...
  $insertSQL = sprintf("INSERT INTO individu (G_SANG_IND, SEXE_IND, NOM_IND, PRENOM_IND, DATEH_NAIS, NATIONALITE_INDIVIDU, ID_IND, NUM_IDENTIFIANT_PERE, NUM_IDENTIFIANT_MERE, NUM_IDENTIFIANT_OEC, NUM_IDENTIFIANT_TEMOIN1, NUM_IDENTIFIANT_TEMOIN2, CHAMP_CREE_PAR, RELIGION) VALUES (%s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO document (NO_DOC, TYPE_DOC, LIEU_EVENNEMENT, NO_CERTIFICAT_PRENUPTIAL, DATE_EVENNEMENT, ID_IND, CHAMP_CREE_PAR) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE individu SET ID_PARRAIN_MARRIAGE=%s, ID_MARRAINNE_MARRIAGE=%s, ID_PRETRE2=%s WHERE ID_IND=%s",
                       GetSQLValueString($_POST['ID_TEM1'], "text"),
                       GetSQLValueString($_POST['ID_TEM2'], "text"),
                       GetSQLValueString($_POST['ID_P'], "text"),
...
function formValidator(){
	...
	if(isAlphabet(NOM_IND, "VALEUR NOM INCORRECT, VEUILLEZ ENTRER QUE DES LETTRES CE CHAMP!!!")){
	   if(isAlphabet2(PRENOM_IND, "VALEUR PRENOM INCORRECT, VEUILLEZ ENTRER QUE DES LETTRES CE CHAMP!!!")){
	      if(isAlphabet3(LIEU_EVENNEMENT, "NOM HOPITAL INCORRECT, VEUILLEZ ENTRER QUE DES LETTRES CE CHAMP!!!")){
		      if(isAlphabet4(NOM_RUE, "NOM RUE INCORRECT, VEUILLEZ ENTRER QUE DES LETTRES CE CHAMP!!!")){
			        ...
			        if(isNumeric(numero, "NOMBRE UNIQUEMENT POUR LE NUMERO DU BATIMENT!!!")){
				       if(madeSelection(SEXE_IND, "SEXE INCORRECT, VEUILLEZ EN CHOISIR UN!!!")){
					      if(madeSelection1(G_SANG_IND, "GROUPE SANGUIN INCORRECT, VEUILLEZ EN CHOISIR UN!!!")){
						     if(madeSelection2(NATIONALITE_INDIVIDU, "NATIONALITE INCORRECT")){
						        if(madeSelection3(RELIGION, "RELIGION INCORRECT")){
							       return true;
								}
						     }
					      }
...
?>
  ...
  <div class="story">
    ...
    <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>" onsubmit="return formValidator()">
      <table border="0" cellpadding="0" cellspacing="0" id="midTable" align="center">
        <tr class="head">
          <td colspan="7" class="header" align="center">INFORMATIONS A REMPLIR</td>
        </tr>
        <tr>
  ...
  &nbsp;&nbsp;
          ...
          <td width="81"><span class="style16">HEURE EVENNEMENT</span></td>
          <td width="199"><span class="style16">
            <label>Hre.&nbsp;
...
( 24h)</label>
        ...
        <tr>
          <td height="25" colspan="3"><span class="style16"><a href="#" onClick="openFormWin('popupere.php');return false;">RECHERCHER EPOUX</a>                            
          </span>
          <div id="prop" style="display:inline"></div></td>
          <td colspan="3"><div id="prop1" style="display:none">NOM: <input name="NOM_EPOUSE" type="text" readonly="readonly"/> PRENOM : <input name="PRENOM_EPOUSE" type="text" readonly="readonly"/> <input name="ID_EPOUSE" type="hidden" />
          </div>            
          <a href="#" class="style16" onclick="openFormWin2('popupmere.php');return false;">RECHERCHER EPOUSE</a></td>
        </tr>
        <tr>
          <td height="45"><span style="display:inline">NOM: <br />
PRENOM : </span></td>
          <td height="45" colspan="2"><span style="display:inline">
            <input name="lname" align="right" type="text" readonly="readonly"/>
            <input name="fname" align="right"type="text" readonly="readonly"/>
            <input name="ID_EPOUX" type="hidden" />
          </span></td>
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
          <td height="45"><span style="display:inline">NOM PERE:
        ...
        <tr>
          <td height="83"><div id="prop5" style="display:inline">
            NOM MERE: <br />NOM JEUNE FILLE: PRENOM MERE:
            </div>
            </td>
          <td height="83" colspan="2"><label>
            <input name="" type="text" name="NOM_MERE" id="NOM_MERE" />
            <br />
        ...
        <tr>
          <td height="89"><a href="#" class="style16" onClick="openFormWin3('popuptem1.php');return false;">Rechercher 1er temoin</a></td>
          <td><div id="prop2" style="display:none">NOM: <input name="NOM_TEM1" type="text" readonly="readonly"/> PRENOM : <input name="PRENOM_TEM1" type="text" readonly="readonly"/> <input name="ID_TEM1" type="hidden" /></div></td>
          <td colspan="2"><a href="#" class="style16" onClick="openFormWin4('popuptem2.php');return false;">Rechercher 2eme temoin</a></td>
          <td colspan="2"><div id="prop3" style="display:none">NOM: <input name="NOM_TEM2" type="text" readonly="readonly"/> PRENOM : <input name="PRENOM_TEM2" type="text" readonly="readonly"/> <input name="ID_TEM2" type="hidden" />
          </div></td>
        </tr>
                    
        <tr>
          <td height="90"><a href="#" class="style16" onClick="openFormWin5('popupoec.php');return false;">Rechercher Officier Etat Civil</a></td>
          <td><div id="prop4" style="display:none">NOM: <input name="NOM_OEC" type="text" readonly="readonly"/> PRENOM: <input name="PRENOM_OEC" type="text" readonly="readonly"/> <input name="ID_OEC" type="hidden" /></div></td>
          <td colspan="2"><a href="#" class="style16" onClick="openFormWin4('popuptem2.php');return false;">Rechercher Prêtre</a></td>
          <td colspan="2"><div id="prop3" style="display:none">NOM: <input name="NOM_P" type="text" readonly="readonly"/> PRENOM : <input name="PRENOM_P" type="text" readonly="readonly"/> <input name="ID_P" type="hidden" />
          </div></td>
        </tr>
      </table>
      <p>
