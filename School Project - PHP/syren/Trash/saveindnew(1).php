...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  ...
  $insertSQL = sprintf("INSERT INTO individu (G_SANG_IND, SEXE_IND, NOM_IND, PRENOM_IND, DATEH_NAIS, NATIONALITE_INDIVIDU, ID_IND, NUM_IDENTIFIANT_PERE, NUM_IDENTIFIANT_MERE, NUM_IDENTIFIANT_OEC, NUM_IDENTIFIANT_TEMOIN1, NUM_IDENTIFIANT_TEMOIN2) VALUES (%s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_connex, $connex);
$query_SECCOM = "SELECT sectioncom.ID_SECCOM, sectioncom.NOM_SECCOM FROM sectioncom, commune WHERE sectioncom.ID_COM = commune.ID_COM";
...
?>
			...
			?>
              ...
              <div class="story">
                ...
                <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>">
		          <table width="91%" border="1" id="comliste" align="center">
                    <tr class="head">
                      <td colspan="6"><div align="center" class="fonce">INFORMATIONS A REMPLIR</div></td>
                    </tr>
                    <tr>
                      <td width="86">NUMERO DOCUMENT</td>
                      <td colspan="2"><span class="style10 style10 style16">
                        <label>
                          <input name="NO_DOC" type="text" id="NO_DOC" size="20" maxlength="8" />
                        </label>
                      </span></td>
                      <td width="78">TYPE DOCUMENT</td>
                      <td colspan="2"><input name="TYPE_DOC" type="text" id="TYPE_DOC" value="NAISSANCE" size="20" readonly="readonly"/></td>
                    </tr>
                    <tr>
                      <td>NOM </td>
                      <td colspan="2"><input name="NOM_IND" type="text" id="NOM_IND" size="20" /></td>
                      <td>PRENOM</td>
                      <td colspan="2"><input name="PRENOM_IND" type="text" id="PRENOM_IND" size="20" /></td>
                    </tr>
                    <tr>
                      <td>SEXE</td>
  ...
  &nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                      <td>ADRESSE</td>
                      <td colspan="5"><p align="left" class="style16">
                        <select name="DEPARTEMENT" id="DEPARTEMENT">
                          <option value="" <?php if (!(strcmp("", $row_DEPARTEMENT['NOM_DEPT']))) {echo "selected=\"selected\"";} ?>>DEPARTEMENT</option>
                          <?php
do {  
?><option value="<?php echo $row_DEPARTEMENT['ID_DEPT']?>"<?php if (!(strcmp($row_DEPARTEMENT['ID_DEPT'], $row_DEPARTEMENT['NOM_DEPT']))) {echo "selected=\"selected\"";} ?>><?php echo $row_DEPARTEMENT['NOM_DEPT']?></option>
                          <?php
...
?>
                        ...
                        <select name="ARRONDISSEMENT" id="ARRONDISSEMENT">
                          <option value="" <?php if (!(strcmp("", array ($row_DEPARTEMENT['ID_DEPT'])))) {echo "selected=\"selected\"";} ?>>ARRONDISSEMENT</option>
                          <?php
do {  
?><option value="<?php echo $row_ARRONDISSEMENT['ID_ARRON']?>"<?php if (!(strcmp($row_ARRONDISSEMENT['ID_ARRON'], array ($row_DEPARTEMENT['ID_DEPT'])))) {echo "selected=\"selected\"";} ?>><?php echo $row_ARRONDISSEMENT['NOM_ARRON']?></option>
                          <?php
...
<select name="SECCOM" id="SECCOM">
  ...
  <?php
do {  
?><option value="<?php echo $row_SECCOM['ID_SECCOM']?>"><?php echo $row_SECCOM['NOM_SECCOM']?></option>
  <?php
...
<br />
                          <br />
                          <input name="NOM_RUE" type="text" id="NOM_RUE" size="80" />
                          <br />
                          </label>
                      </p>                        </td>
                    </tr>
                    <tr>
                      <td><a href="#" onClick="openFormWin('popupere.php');return false;">Rechercher PERE</a></p>                            </td>
                      ...
                      <td><a href="#" onClick="openFormWin2('popupmere.php');return false;">Rechercher MERE</a></td>
