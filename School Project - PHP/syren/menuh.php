...
?>
      ...
      <li><a href="#" class="MenuBarItemSubmenu">Individus</a>
        <ul>
          ...
          <li><a href="#">Enregistrer</a>
            <ul>
            <li><a href="saveind.php">Naissance</a></li>
      ...
      <?php if(($groupe == "administrateur ime")||($groupe == "operateur ime")) {?> 
	  <li><a href="#" class="MenuBarItemSubmenu">Voyages</a>
        <ul>
          <li><a href="presavevoyage.php">Enregistrer</a></li>
          <li><a href="liste_voyage.php">Lister</a></li>
          <li><a href="rech_voy_ind.php">Rechercher</a></li>
        </ul>
      </li><?php }?>
	  <?php 
  ...
  <li><a  href="recherche_avancee.php">Rech. Avanc&eacute;e</a></li>
  <?php } ?>
      <li><a  href="actugen.php">Actualites</a></li>
