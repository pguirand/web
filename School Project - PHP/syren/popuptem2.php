...
<form name="popForm" onsubmit="setMaster()">
                <input name="lname2" type="hidden" value="<?php echo $row_rechByNif['NOM_IND']; ?>">
<br>
<input name="fname2" type="hidden" value="<?php echo $row_rechByNif['PRENOM_IND'];?>" /><br>
<input name="id2" type="hidden" value="<?php echo $row_rechByNif['ID_IND'];?>"/>
