...
switch($groupe)
	{
		...
		case "administrateur oni"			:	$MM_redirectLoginSuccess = "../admoni.php";
												break;
       case "administrateur justice"		:	$MM_redirectLoginSuccess = "../admjustice.php";
												break;	
		case "administrateur sante"			:	$MM_redirectLoginSuccess = "../admsante.php";
												break;													
		case "administrateur economie"		:	$MM_redirectLoginSuccess = "../admecono.php";
												break;
...
?>
   ...
   <td><a href="../viewentites.php?ID_ENTITE=<?php echo $row_recherche['ID_ENTITE']; ?>" title="Détails"><?php echo $row_recherche['NOM_ENTITE']; ?></a></td>
