...
?>
  ...
  <div class="story">
    ...
    <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>" onsubmit="return formValidator()">
      <table border="0" cellpadding="0" cellspacing="0" id="midTable" align="center">
        ...
        <tr>
          <td><span class="style16">TYPE DOCUMENT</span></td>
          ...
          <td><span class="style16">NO DOCUMENT</span></td>
          ...
          <td>NO PAGE</td>
          <td><input name="NO_PAGE" type="text" class="style16" id="NO_PAGE" style="text-transform:uppercase" size="10" maxlength="8"/></td>
        </tr>
        <tr>
          <td width="81"><span class="style16">NOM </span></td>
        ...
        <tr>
          ...
          <td colspan="4"><select name="G_SANG_IND" class="style16" id="G_SANG_IND">
          ...
          <td width="82"><span class="style16">NATIONALITE</span></td>
          <td width="169"><select name="NATIONALITE_INDIVIDU" class="style16" id="NATIONALITE_INDIVIDU">
  ...
  &nbsp;&nbsp;
          ...
          <td width="93"><span class="style16">HEURE DE NAISSANCE</span></td>
...
$dForm->DynamicDropDown_Close();   //Call to the Destructor type of function
        ...
        <tr>
          ...
          <td colspan="4"><a href="#" class="style16" onClick="openFormWin2('popupmere.php');return false;">Rechercher M&egrave;re	</a></td>
        ...
        <tr>
          ...
          <td colspan="4"><a href="#" class="style16" onClick="openFormWin4('popuptem2.php');return false;">Rechercher 2eme temoin</a></td>
        ...
        <tr>
          ...
          <td colspan="5"><span class="style16">
            <input name="NUM_TEL1" type="text" class="style16" id="NUM_TEL1" value="509-0000-0000"/>
            </span><span class="style16">
            <input name="NUM_TEL2" type="text" class="style16" id="NUM_TEL2" value="509-0000-0000"/>
          </span>
          <span class="style16">
            <input name="NUM_TEL3" type="text" class="style16" id="NUM_TEL3" value="509-0000-0000"/>
          </span>
            <input name="NUM_TEL4" type="text" class="style16" id="NUM_TEL4" value="509-0000-0000"/>
          </td>
        </tr>
      </table>
      <p>
