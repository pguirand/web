...
$critere = array($clause_nom,$clause_prenom,$clause_sexe,$clause_prof,$clause_grsang,$clause_matri,$clause_etat,$clause_relig,$clause_ages);
$i=0;
while($i<9)
{
if ($critere[$i]!="")
  ...
  <form id="form2" name="form2" method="GET" action="<?php echo $RechAdv; ?>">
	...
	<div align="center" id="crit">
      <table width="774" border="0" cellpadding="0" cellspacing="0" id="comliste">
        <tr class="head">
          <td colspan="5"><div align="center" class="fonce">INFORMATIONS PERSONNELLES
        ...
        <tr>
          ...
          <td colspan="2"> <div align="center">Ages : <br />
          </div>
            <br />
...
<label></label>
          ...
          <td width="141" align="center">
            <input type="radio" name="dateage" value="radio" id="dateage_0" />
Ages          </td>
          <td width="141" align="center"><input type="radio" name="dateage" value="radio" id="dateage_1" />
Dates</td>
        </tr>
        <tr>
          <td colspan="2" align="center">Dates de naissance<br />
  ...
  <select name="an" class="style16" id="an">
    ...
    <option>2020</option>
        ...
        <tr>
          ...
          <td colspan="2" align="center">Dates de deces<br />
