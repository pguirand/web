...
$query_nomutil = "SELECT utilisateur.NOM_UTIL,  utilisateur.ID_IND FROM utilisateur WHERE utilisateur.NOM_UTIL='$nomutil' and utilisateur.ID_IND='$idind'";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1") && $existe == "non") {
  ...
  $insertGoTo = "saveutiloksyren.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" onSubmit="return formValidator()">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="65%" border="2" id="comliste2">
    <tr>
...
?>
    ...
    <tr>
      <td width="172" class="style12"><div align="left">NOM UTILISATEUR</div></td>
      <td width="434" class="style12"><label>
