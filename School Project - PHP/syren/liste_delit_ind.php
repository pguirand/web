...
$query_liste_delit = "SELECT * FROM delit";
$liste_delit = mysql_query($query_liste_delit, $connex) or die(mysql_error());
$row_liste_delit = mysql_fetch_assoc($liste_delit);
$totalRows_liste_delit = mysql_num_rows($liste_delit);
?>
...
?>
  ...
  <table border="1" id="comliste" align="center">
  <tr class="head">
    <td>DESCRIPTION DELIT</td>
    <td>TYPE DELIT</td>
    <td>GRAVITE DELIT</td>
  </tr>
  <tr>
    <td><?php echo $row_liste_delit['DESCRIPTION_DELIT']; ?></td>
    <td><?php echo $row_liste_delit['TYPE_DELIT']; ?></td>
    <td><?php echo $row_liste_delit['GRAVITE_DELIT']; ?></td>
  </tr>
</table>
