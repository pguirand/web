...
echo			$query_rechByNif = sprintf("SELECT * FROM individu WHERE ".$champs." = %s ".$reqAge." ".$reqPitit." ORDER BY ".$champs." ASC", GetSQLValueString($colname_rechByNif, "text"));
