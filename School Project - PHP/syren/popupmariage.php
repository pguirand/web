...
<form id="form2" name="form2" method="GET" action="<?php echo $rechByNifAction; ?>">
                  ...
                  <h3 align="center">Recherche de l'&eacute;poux</h3>
...
<form name="popForm" onsubmit="setMaster()">
                <input name="lname" type="hidden" value="<?php echo $row_rechByNif['NOM_IND']; ?>">
<br>
<input name="fname" type="hidden" value="<?php echo $row_rechByNif['PRENOM_IND'];?>" /><br>
<input name="id" type="hidden" value="<?php echo $row_rechByNif['ID_IND'];?>"/>
<input name="PRENOM_PERE" type="hidden" value="<?php echo $row_pere['PRENOM_IND'];?>"/>
<input name="NOM_PERE" type="hidden" value="<?php echo $row_pere['NOM_IND'];?>"/>
<input name="PRENOM_MERE" type="hidden" value="<?php echo $row_mere['PRENOM_IND'];?>"/>
<input name="NOM_JEUNE_FILLE_MERE" type="hidden" value="<?php echo $row_mere['NOM_JEUNE_FILLE'];?>"/>
<input name="NOM_MERE" type="hidden" value="<?php echo $row_mere['NOM_IND'];?>"/>
<input name="SEXE_IND" type="hidden" value="<?php echo $row_rechByNif['SEXE_IND'];?>" />
