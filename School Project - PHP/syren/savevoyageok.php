...
?>
    <?php
      ...
      <br /><br /><br />
      </p><div class="logoutok"> 
        <p align="center">Le VOYAGE A ETE ENREGISTRE AVEC SUCCES</p>
        <table border="0" width="500" align="center"><tr><td>
          <a href="presavevoyage.php">
          Nouvel Enregistrement</a></td>
          <td>                
          <a href="admime.php">Retour à Administration</a></td>
        </table>
              </div>
  <?php
	}
