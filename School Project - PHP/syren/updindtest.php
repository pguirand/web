...
?>
        ...
        <tr class="style14">
          ...
          <label>
          <input type="button" name="Generer NIF" id="Generer NIF" value="Generer NIF" onclick="rand()"/>
...
<select name="an3" class="style14" id="an3"<?php if (($groupe != "operateur ime")&&($groupe != "administrateur ime")){?> disabled="disabled"<?php } ?>>
  ...
  <option>2020</option>
        ...
        <tr class="style14">
          ...
          <td colspan="2"><input name="email1" type="text" style="text-transform:lowercase" class="style14" id="email1" value="<?php echo $row_Recordset1['EMAIL1']; ?>" /></td>
        </tr>
        <tr class="style14">
          <td>PHOTO INDIVIDU</td>
  ...
  <input name="NOM_RUE" type="text"  disabled="disabled" class="style14" id="NOM_RUE" value="<?php echo $row_Recordset1['NOM_RUE']; ?>" size="55" style="text-transform:uppercase"/>
              <label>
              <input name="ID_SECCOM" type="text"  disabled="disabled" class="style14" id="ID_SECCOM" value="<?php echo $row_Recordset1['ID_SECCOM']; ?>"/>
              </label>
            </p></td>
        </tr>
        <tr class="style14">
