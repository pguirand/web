   ...
   <div class="fonce">Résultats</div> 
    <table border="1" id="comliste">
      ...
      <tr>
        ...
        <td><a href="view_hopital.php?ID_ENTITE=<?php echo $row_rechByNif['ID_ENTITE']; ?>" title="Visualiser Entité"><input name="SELECTIONNER" type="button" value="SELECTIONNER" align="middle" /></a></td>
        </tr>
