...
if(madeSelection(SEXE_IND, "SEXE INCORRECT, L'EPOUX NE PEUX PAS ETRE UNE FEMME!!!")){
							          return true;
									}  
    ...
    <form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>" onsubmit="return formValidator()">
      <table border="0" cellpadding="0" cellspacing="0" id="midTable" align="center">
        ...
        <tr>
          ...
          <td width="198"><span class="style10 style10 style16">
...
( 24h)</label>
        ...
        <tr class="head">
          <td colspan="7" class="header fonce style12" align="center">Informations relatives aux &eacute;poux</td>
        </tr>
        <tr>
          <td height="25" colspan="3"><span class="style16"><a href="#" onClick="openFormWin('popupmariage.php');return false;">RECHERCHER EPOUX</a>                            
          </span>          </td>
          <td colspan="3"><div id="prop1" style="display:inline"></div>            
          <a href="#" class="style16" onclick="openFormWin2('popupepouse.php');return false;">RECHERCHER EPOUSE</a></td>
        </tr>
...
PRENOM : </td>
          <td height="45" colspan="2" class="style16">
            ...
            <input name="SEXE_IND" align="right" type="hidden" readonly="readonly" id="SEXE_IND"/>
            </td>
          <td width="115" class="style16"><span style="display:inline">NOM:<br />PRENOM :</span></td>
          <td colspan="2" class="style16"><span style="display:inline">
            ...
            <input name="ID_EPOUSE" type="hidden" />
          </span></td>
        </tr>
        <tr>
...
PRENOM PERE:</span></span></td>
        ...
        <tr>
          <td height="28" colspan="2"><a href="#" class="style16" onClick="return checkId(form2); openFormWin3('popuptem1.php'); return false;">RECHERCHER PARRAIN</a><br /></td>
          <td colspan="4"><a href="#" class="style16" onClick="openFormWin4('popuptem2.php');return false;">RECHERCHE MARRAINE</a><br /></td>
        </tr>
        <tr>
          <td height="45" class="style16">NOM:<br /> 
          PRENOM :</td>
          ...
          <input name="id2" type="hidden" /></td>
        </tr>
                    
        <tr>
          <td height="25" colspan="2" class="style16"><a href="#" class="style16" onClick="openFormWin5('popupoec.php');return false;">RECHERCHER OFFICIER D'ETAT CIVIL</a></td>
          <td colspan="4" class="style16"><a href="#" class="style16" onClick="openFormWin4('popuppretre.php');return false;">RECHERCHER PRETRE</a></td>
        </tr>
        <tr>
          <td height="45" class="style16">NOM:<br />
          PRENOM:</td>
