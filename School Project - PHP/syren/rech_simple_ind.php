   ...
   <div class="fonce">Résultats</div> 
    <table border="1" id="comliste">
      ...
      <tr>
        ...
        <td><a href="updindtest3.php?ID_IND=<?php echo $row_rechByNif['ID_IND']; ?>" title="Modifier Individu"><img src="images/pencilart.jpeg" width="20" height="20"  border="0" /></a></td>
        <td><a href="viewind.php?ID_IND=<?php echo $row_rechByNif['ID_IND']; ?>" title="Visualiser Individu"><img src="images/eyeart.jpeg" width="20" height="20"  border="0" /></a></td>
        <?php if (($groupe == "administrateur archives")|| ($groupe == "operateur archives")){?>
         <td><a href="filenais.php?ID_IND=<?php echo $row_rechByNif['ID_IND']; ?>" title="Voir Document"><img src="images/adobe1.jpg" width="20" height="20"  border="0" /></a></td>
         <?php }?>
      </tr>
</table>
    <br><br>
