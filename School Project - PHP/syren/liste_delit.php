...
$query_liste_inf = "SELECT DESCRIPTION_DELIT, TYPE_DELIT, GRAVITE_DELIT, DATE_DELIT, DATE_ARREST, DUREE_PEINE FROM delit";
$liste_inf = mysql_query($query_liste_inf, $connex) or die(mysql_error());
$row_liste_inf = mysql_fetch_assoc($liste_inf);
$totalRows_liste_inf = mysql_num_rows($liste_inf);
?>
...
?>
  ...
  <div class="content"> 
    <form id="form2" name="form2" method="post" action="">
      <p>&nbsp;</p>
      <p><label> Par Infraction:</label>
        <select name="GRAVITE_DELIT" id="GRAVITE_DELIT">
          <option selected="selected">Contravention</option>
          <option>D&eacute;lit</option>
          <option>Crime</option>
        </select>
      </p>
      <p>&nbsp;</p>
