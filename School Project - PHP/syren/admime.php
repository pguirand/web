...
?>
  ...
  <p>
    <br><br><br>
  <div class="warning"> 
    <p>DIRECTION DE L'IMMIGRATION ET DE L'EMIGRATION D'HAITI<br>
      <br><br>
      <br>
    La Direction de l'Immigration et l'Emigration est un Service D&eacute;concentr&eacute; du  Minist&egrave;re de l'Interieur et des Collectivit&eacute;s Territoriales</p>
    <p>La Direction de l'Immigration et l'Emigration a pour attributions essentielles : </p>
    <ol>
      <li>
        <div align="left">L'attribution de passeports ; </div>
      </li>
      <li>
        <div align="left">L'octoie des permis de S&eacute;jour ; </div>
      </li>
      <li>
        <div align="left">Assure le controle des ports d'entr&eacute;s sur le Territoire Haitien ;</div>
      </li>
    </ol>
  </div>
  <?php
