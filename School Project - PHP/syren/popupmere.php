...
<form name="popForm" onsubmit="setMaster()">
                <input name="lnamem" type="hidden" value="<?php echo $row_rechByNif['NOM_IND']; ?>">
<br>
<input name="fnamem" type="hidden" value="<?php echo $row_rechByNif['PRENOM_IND'];?>" /><br>
<input name="idm" type="hidden" value="<?php echo $row_rechByNif['ID_IND'];?>"/>
